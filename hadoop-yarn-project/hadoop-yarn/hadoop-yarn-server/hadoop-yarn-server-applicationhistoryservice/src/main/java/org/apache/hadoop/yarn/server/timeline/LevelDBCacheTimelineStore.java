...
public class LevelDBCacheTimelineStore extends MapTimelineStore {
  ...
  public LevelDBCacheTimelineStore(String id, String name) {
    ...
    dbId = id;
    entityInsertTimes
        = new MemoryTimelineStore.HashMapStoreAdapter<EntityIdentifier, Long>();
    domainById
        = new MemoryTimelineStore.HashMapStoreAdapter<String, TimelineDomain>();
    domainsByOwner
        = new MemoryTimelineStore.HashMapStoreAdapter
          <String, Set<TimelineDomain>>();
  }
  ...
  protected void serviceInit(Configuration conf) throws Exception {
    ...
    entities
        = new LevelDBMapAdapter<EntityIdentifier, TimelineEntity>(entityDb);
