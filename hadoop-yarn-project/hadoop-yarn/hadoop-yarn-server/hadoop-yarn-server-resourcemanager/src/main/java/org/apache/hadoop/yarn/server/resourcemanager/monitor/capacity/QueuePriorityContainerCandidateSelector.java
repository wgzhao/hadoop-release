...
public class QueuePriorityContainerCandidateSelector
  ...
  private boolean preChecksForMovingReservedContainerToNode(
    ...
    ResourceRequest offswithRequest =
        app.getAppSchedulingInfo().getResourceRequest(
            reservedContainer.getReservedPriority(), ResourceRequest.ANY);
  ...
  private void tryToMakeBetterReservationPlacement(
      ...
      Collection<FiCaSchedulerNode> allSchedulerNodes) {
    for (FiCaSchedulerNode targetNode : allSchedulerNodes) {
      ...
      if (canPreemptEnoughResourceForAsked(
        ...
        NodeId fromNode = reservedContainer.getReservedNode();
  ...
  public Map<ApplicationAttemptId, Set<RMContainer>> selectCandidates(
    ...
    Collection<FiCaSchedulerNode> allSchedulerNodes =
        preemptionContext.getScheduler().getAllNodes().values();
