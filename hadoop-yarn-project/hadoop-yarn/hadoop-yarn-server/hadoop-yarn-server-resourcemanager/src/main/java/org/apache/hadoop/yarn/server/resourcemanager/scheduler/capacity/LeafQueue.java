...
public class LeafQueue extends AbstractCSQueue {
  ...
  public LeafQueue(CapacitySchedulerContext cs, 
    ...
    setupQueueConfigs(cs.getClusterResource(), capacity, absoluteCapacity,
        ...
        maxActiveApplications, maxActiveApplicationsPerUser, state, acls, cs
            .getConfiguration().getNodeLocalityDelay(), cs.getConfiguration()
            .getReservationContinueLook(), labels, defaultLabelExpression);
  ...
  private synchronized void setupQueueConfigs(Resource clusterResource,
      ...
      boolean continueLooking, Set<String> labels, 
      String defaultLabelExpression) throws IOException
  {
    super.setupQueueConfigs(clusterResource, capacity, absoluteCapacity,
        maximumCapacity, absoluteMaxCapacity, state, acls, continueLooking,
        labels, defaultLabelExpression);
