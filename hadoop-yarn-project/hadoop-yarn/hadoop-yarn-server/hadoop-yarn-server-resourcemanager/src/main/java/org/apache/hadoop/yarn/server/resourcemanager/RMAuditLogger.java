...
public class RMAuditLogger {
  ...
  private static void appendCallerContext(StringBuilder sb, CallerContext callerContext) {
    ...
    if (callerContext != null) {
      ...
      final byte[] signatureBytes = callerContext.getSignature();
      signature = signatureBytes == null ?
          null : new String(signatureBytes, CallerContext.SIGNATURE_ENCODING);
    }
    ...
    if (signature != null) {
      add(Keys.CALLERSIGNATURE, signature, sb);
    }
  }
