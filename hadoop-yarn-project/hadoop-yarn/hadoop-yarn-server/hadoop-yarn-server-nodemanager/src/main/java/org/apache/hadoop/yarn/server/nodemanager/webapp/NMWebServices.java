...
public class NMWebServices {
  ...
  public NMWebServices(final Context nm, final ResourceView view,
    ...
    this.rview = view;
    this.webapp = webapp;
    this.redirectWSUrl = this.nmContext.getLocalDirsHandler().getConfig().get(
    ...
    try {
      ...
      try {
        List<ContainerLogMeta> containerLogMeta = LogToolUtils
            .getContainerLogMetaFromRemoteFS(
                this.nmContext.getLocalDirsHandler().getConfig(),
      ...
      StreamingOutput stream = new StreamingOutput() {
        ...
        public void write(OutputStream os) throws IOException,
          ...
          try {
            ...
            String appOwner = app == null ? null : app.getUser();
            try {
              LogToolUtils.outputAggregatedContainerLog(
                  nmContext.getLocalDirsHandler().getConfig(),
