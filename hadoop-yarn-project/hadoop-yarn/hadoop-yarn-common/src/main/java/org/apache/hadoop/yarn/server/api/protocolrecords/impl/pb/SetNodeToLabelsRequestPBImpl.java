...
import org.apache.hadoop.yarn.proto.YarnServerResourceManagerServiceProtos.SetNodeToLabelsRequestProtoOrBuilder;
import org.apache.hadoop.yarn.server.api.protocolrecords.SetNodeToLabelsRequest;

import com.google.common.collect.Sets;

public class SetNodeToLabelsRequestPBImpl extends
    SetNodeToLabelsRequest {
  SetNodeToLabelsRequestProto proto = SetNodeToLabelsRequestProto
      .getDefaultInstance();
  SetNodeToLabelsRequestProto.Builder builder = null;
  boolean viaProto = false;

  private Map<String, Set<String>> nodeToLabels;
  
  public SetNodeToLabelsRequestPBImpl() {
    this.builder = SetNodeToLabelsRequestProto.newBuilder();
  }

  public SetNodeToLabelsRequestPBImpl(SetNodeToLabelsRequestProto proto) {
    this.proto = proto;
    this.viaProto = true;
  }
  ...
  private void initNodeToLabels() {
    ...
    SetNodeToLabelsRequestProtoOrBuilder p = viaProto ? proto : builder;
  ...
  private void maybeInitBuilder() {
    if (viaProto || builder == null) {
      builder = SetNodeToLabelsRequestProto.newBuilder(proto);
    }
    viaProto = false;
  }
  ...
  public SetNodeToLabelsRequestProto getProto() {
    mergeLocalToProto();
