...
public class NodeLabelTestBase {
  public static void assertMapEquals(Map<String, Set<String>> m1,
      ImmutableMap<String, Set<String>> m2) {
  ...
  public static void assertMapContains(Map<String, Set<String>> m1,
      ImmutableMap<String, Set<String>> m2) {
