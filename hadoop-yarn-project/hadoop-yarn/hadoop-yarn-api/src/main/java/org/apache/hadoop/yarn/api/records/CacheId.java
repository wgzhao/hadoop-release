...
public abstract class CacheId implements Comparable<CacheId>{
  ...
  @Private
  @Unstable
  protected abstract void setCacheId(String cacheId);

  @Override
  public int hashCode() {
    int result = getCacheId().hashCode();
  ...
  public boolean equals(Object obj) {
    ...
    if (!this.getApplicationId().equals(other.getApplicationId()))
      return false;
    if (!this.getCacheId().equals(other.getCacheId())) {
      return false;
    };
    return true;
  }
  ...
  public int compareTo(CacheId other) {
    ...
    if (compareAppIds == 0) {
      return this.getCacheId().compareTo(other.getCacheId());
    } else {
  ...
  public static CacheId fromString(String cacheIdStr) {
    ...
    return CacheId.newInstance(appId, id);
  }
