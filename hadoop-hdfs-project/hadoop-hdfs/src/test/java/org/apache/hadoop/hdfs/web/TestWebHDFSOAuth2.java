...
public class TestWebHDFSOAuth2 {
  ...
  @Before
  public void checkCompatibleJDK() {
    assumeTrue(System.getProperty("java.version").substring(0, 3)
        .compareTo("1.7") >= 0);
  }
  ...
  public Configuration getConfiguration() {
    ...
    // Configs for OAuth2
    conf.setBoolean(DFSConfigKeys.DFS_WEBHDFS_OAUTH_ENABLED_KEY, true);
