...
*/
  ...
  public void testReplicationWithPriority() throws Exception {
    ...
    try {
      ...
      for (int i = 0; i < 100; i++) {
        ...
        neededReplications.add(new Block(random.nextLong()), 2, 0, 0, 3);
      }
      ...
      neededReplications.add(new Block(random.nextLong()), 1, 0, 0, 3);
  ...
  public void testChooseUnderReplicatedBlocks() throws Exception {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      underReplicatedBlocks.add(new Block(random.nextLong()), 1, 0, 0, 3);

      // Adding QUEUE_VERY_UNDER_REPLICATED block
      underReplicatedBlocks.add(new Block(random.nextLong()), 2, 0, 0, 7);

      // Adding QUEUE_REPLICAS_BADLY_DISTRIBUTED block
      underReplicatedBlocks.add(new Block(random.nextLong()), 6, 0, 0, 6);

      // Adding QUEUE_UNDER_REPLICATED block
      underReplicatedBlocks.add(new Block(random.nextLong()), 5, 0, 0, 6);

      // Adding QUEUE_WITH_CORRUPT_BLOCKS block
      underReplicatedBlocks.add(new Block(random.nextLong()), 0, 0, 0, 3);
    }
    ...
    underReplicatedBlocks.add(new Block(random.nextLong()), 0, 1, 0, 3);
  ...
  private void assertTheChosenBlocks(
      List<List<Block>> chosenBlocks, int... expectedSizes) {
    int i = 0;
