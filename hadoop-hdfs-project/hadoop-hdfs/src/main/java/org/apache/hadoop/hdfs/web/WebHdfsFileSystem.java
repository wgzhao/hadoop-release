...
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_WEBHDFS_REST_CSRF_CUSTOM_HEADER_DEFAULT;
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_WEBHDFS_REST_CSRF_CUSTOM_HEADER_KEY;
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_WEBHDFS_REST_CSRF_ENABLED_DEFAULT;
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_WEBHDFS_REST_CSRF_ENABLED_KEY;
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_WEBHDFS_REST_CSRF_METHODS_TO_IGNORE_DEFAULT;
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_WEBHDFS_REST_CSRF_METHODS_TO_IGNORE_KEY;
...
public class WebHdfsFileSystem extends FileSystem
  ...
  public synchronized void initialize(URI uri, Configuration conf
    ...
    boolean isOAuth = conf.getBoolean(
        DFSConfigKeys.DFS_WEBHDFS_OAUTH_ENABLED_KEY,
        DFSConfigKeys.DFS_WEBHDFS_OAUTH_ENABLED_DEFAULT);
  ...
  public synchronized void setWorkingDirectory(final Path dir) {
    ...
    String result = absolutePath.toUri().getPath();if (!DFSUtil.isValidName(result)) {
  ...
  protected BlockLocation[] getFileBlockLocations(
      final GetOpParam.Op operation, final Path path,
      final long offset, final long length) throws IOException {
