...
public class RequestHedgingProxyProvider<T> extends
  ...
  class RequestHedgingInvocationHandler implements InvocationHandler {
    ...
    public RequestHedgingInvocationHandler(
      ...
      this.targetProxies = new HashMap<String, ProxyInfo<T>>(
          targetProxies);
    }
    ...
    invoke(Object proxy, final Method method, final Object[] args)
            throws Throwable {
      Map<Future<Object>, ProxyInfo<T>> proxyMap =
        new HashMap<Future<Object>, ProxyInfo<T>>();
      int numAttempts = 0;
      ...
      try {
        ...
        Map<String, Exception> badResults =
  ...
  public synchronized ProxyInfo<T> getProxy() {
    ...
    Map<String, ProxyInfo<T>> targetProxyInfos =
       new HashMap<String, ProxyInfo<T>>();
