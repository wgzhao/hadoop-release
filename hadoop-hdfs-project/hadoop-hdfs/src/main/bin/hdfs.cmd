...
:main
  ...
  set hdfscommands=dfs namenode secondarynamenode journalnode zkfc datanode dfsadmin haadmin fsck balancer mover jmxget oiv oev fetchdt getconf groups snapshotDiff lsSnapshottableDir cacheadmin
