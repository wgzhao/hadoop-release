...
public class TestReuseRpcConnections {
  ...
  public void testDefaultRetryPolicyReuseConnections() throws Exception {
    ...
    rp1 = getDefaultRetryPolicy(
        ...
        new RemoteException(
            ...
            "no such method exception").getClass());
    rp2 = getDefaultRetryPolicy(
        true,
        "70000,8",
        new RemoteException(
            PathIOException.class.getName(),
            "path IO exception").getClass());
    verifyRetryPolicyReuseConnections(rp1, rp2, RetryPolicies.RETRY_FOREVER);
  }
  ...
  private static TestRpcService getClient(
      InetSocketAddress serverAddr,
      Configuration clientConf,
      final RetryPolicy connectionRetryPolicy) throws ServiceException {
    try {
  ...
  private void verifyRetryPolicyReuseConnections(
    ...
    final Server server = TestProtoBufRpc.setupTestServer(conf);
    ...
    try {
      ...
      proxy1.ping(null, TestProtoBufRpc.newEmptyRequest());
      ...
      proxy2.ping(null, TestProtoBufRpc.newEmptyRequest());
      assertEquals("number of connections in cache is wrong", 1, conns.size());
      ...
      proxy3.ping(null, TestProtoBufRpc.newEmptyRequest());
