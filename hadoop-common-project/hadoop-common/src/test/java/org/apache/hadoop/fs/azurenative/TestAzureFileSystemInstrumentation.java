...
public class TestAzureFileSystemInstrumentation {
  ...
  public void testMetricsOnMkdirList() throws Exception {
    ...
    assertEquals(1, getLongCounterValue(getInstrumentation(), WASB_DIRECTORIES_CREATED));
  ...
  public void testMetricsOnFileCreateRead() throws Exception {
    ...
    long uploadRate = getLongGaugeValue(getInstrumentation(), WASB_UPLOAD_RATE);
    ...
    long downloadRate = getLongGaugeValue(getInstrumentation(), WASB_DOWNLOAD_RATE);
  ...
  public void testMetricsOnFileRename() throws Exception {
    ...
    assertEquals(0, getLongCounterValue(getInstrumentation(), WASB_FILES_CREATED));
    ...
    assertEquals(1, getLongCounterValue(getInstrumentation(), WASB_FILES_CREATED));
  ...
  public void testMetricsOnFileExistsDelete() throws Exception {
    ...
    // Delete the file
    assertEquals(0, getLongCounterValue(getInstrumentation(), WASB_FILES_DELETED));
    ...
    assertEquals(1, getLongCounterValue(getInstrumentation(), WASB_FILES_DELETED));
  ...
  public void testClientErrorMetrics() throws Exception {
    ...
    try {
      ...
      assertEquals(1, getLongCounterValue(getInstrumentation(), WASB_CLIENT_ERRORS));
      assertEquals(0, getLongCounterValue(getInstrumentation(), WASB_SERVER_ERRORS));
    } finally {
  ...
  private void assertNoErrors() {
    assertEquals(0, getLongCounterValue(getInstrumentation(), WASB_CLIENT_ERRORS));
    assertEquals(0, getLongCounterValue(getInstrumentation(), WASB_SERVER_ERRORS));
  }
