 ...
 * See RunningLiveWasbTests.txt for instructions on how to connect to a real
...
public final class AzureBlobStorageTestAccount {
   ...
   *
   * @param fs - file system, namely WASB file system
   * @param account - Windows Azure account object
  ...
  public static AzureBlobStorageTestAccount createOutOfBandStore(
    ...
    // Ensure that custom throttling is disabled and tolerate concurrent out-of-band
    // appends.
    //
