...
public class CallerContext {
  /** The caller context.
   * It may be truncated to maximum length before server recording it.
   */
  private final String context;
  /** The caller's signature for validation.
   * The signature is optional but empty string will be abandoned.
   */
  ...
  private static final class CurrentCallerContextHolder {
    static final ThreadLocal<CallerContext> CALLER_CONTEXT =
        new InheritableThreadLocal<CallerContext>();
  }
