...
function Main( $scriptDir )
{
    ...
    $hdfsConfigs = @{
        "dfs.namenode.checkpoint.dir" = ConvertToFileURI(Get-AppendedPath $ENV:HDFS_NAMENODE_DATA_DIR "snn");
        "dfs.namenode.checkpoint.edits.dir" = ConvertToFileURI(Get-AppendedPath $ENV:HDFS_NAMENODE_DATA_DIR "snn");
        "dfs.namenode.name.dir" = ConvertToFileURI(Get-AppendedPath $ENV:HDFS_NAMENODE_DATA_DIR "nn");
        "dfs.datanode.data.dir" = ConvertToFileURI(Get-AppendedPath $ENV:HDFS_DATANODE_DATA_DIR "dn");
