...
public class ITestAzureDistributedFileSystemInitAndCreate extends DependencyInjectedTest {
  public ITestAzureDistributedFileSystemInitAndCreate() throws Exception {
    super();
