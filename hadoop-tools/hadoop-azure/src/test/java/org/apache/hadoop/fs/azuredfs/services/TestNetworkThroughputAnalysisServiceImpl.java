...
public class TestNetworkThroughputAnalysisServiceImpl {
  ...
  public void testNoMetricUpdatesThenNoWaiting() {
    AdfsNetworkTrafficAnalysisServiceImpl adfsNetworkTrafficAnalysisService = new AdfsNetworkTrafficAnalysisServiceImpl(new MockLoggingServiceImpl());
    AdfsHttpClientSessionImpl adfsHttpClientSession = new AdfsHttpClientSessionImpl("testaccount.dfs.core.windows.net", "dGVzdFN0cmluZw==", "testFileSystem");
    adfsNetworkTrafficAnalysisService.subscribeForAnalysis(adfsHttpClientSession, ANALYSIS_PERIOD);

    AdfsNetworkTrafficAnalysisResult adfsNetworkTrafficAnalysisResult = adfsNetworkTrafficAnalysisService.getAdfsNetworkTrafficAnalysisResult(adfsHttpClientSession);
  ...
  public void testOnlySuccessThenNoWaiting() {
    ...
    AdfsNetworkTrafficAnalysisResult adfsNetworkTrafficAnalysisResult = adfsNetworkTrafficAnalysisService.getAdfsNetworkTrafficAnalysisResult(adfsHttpClientSession);
    AdfsNetworkTrafficMetrics adfsNetworkTrafficMetrics = adfsNetworkTrafficAnalysisService.getAdfsNetworkThroughputMetrics(adfsHttpClientSession);
