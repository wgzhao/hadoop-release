...
public class TestNetworkThroughputAnalysisServiceImpl {
  ...
  final AbfsThrottlingNetworkTrafficAnalysisServiceImpl abfsThrottlingNetworkTrafficAnalysisService;
  final AbfsHttpClientSessionImpl abfsHttpClientSession;
  final AbfsThrottlingNetworkTrafficAnalysisResult abfsThrottlingNetworkTrafficAnalysisResult;
  final AbfsThrottlingNetworkTrafficMetrics abfsThrottlingNetworkTrafficMetrics;

  public TestNetworkThroughputAnalysisServiceImpl() {
    this.abfsThrottlingNetworkTrafficAnalysisService = new AbfsThrottlingNetworkTrafficAnalysisServiceImpl(AbfsLoggingTestUtils.createMockLoggingService());
    this.abfsHttpClientSession = new AbfsHttpClientSessionImpl("testaccount.dfs.core.windows.net", "dGVzdFN0cmluZw==", "testFileSystem");
    this.abfsThrottlingNetworkTrafficAnalysisService.subscribeForAnalysis(abfsHttpClientSession, ANALYSIS_PERIOD);
    this.abfsThrottlingNetworkTrafficAnalysisResult = abfsThrottlingNetworkTrafficAnalysisService.getAbfsThrottlingNetworkTrafficAnalysisResult(abfsHttpClientSession);
    this.abfsThrottlingNetworkTrafficMetrics = abfsThrottlingNetworkTrafficAnalysisService.getAbfsThrottlingNetworkThroughputMetrics(abfsHttpClientSession);
  }
  ...
  public void testNoMetricUpdatesThenNoWaiting() {
    validate(0, abfsThrottlingNetworkTrafficAnalysisResult.getReadAnalysisResult().getSleepDuration());
    validate(0, abfsThrottlingNetworkTrafficAnalysisResult.getWriteAnalysisResult().getSleepDuration());
  ...
  public void testOnlySuccessThenNoWaiting() {
    abfsThrottlingNetworkTrafficMetrics.getWriteMetrics().addBytesTransferred(8 * MEGABYTE, false);
    validate(0, abfsThrottlingNetworkTrafficAnalysisResult.getWriteAnalysisResult().getSleepDuration());
    sleep(ANALYSIS_PERIOD_PLUS_10_PERCENT);
    validate(0, abfsThrottlingNetworkTrafficAnalysisResult.getWriteAnalysisResult().getSleepDuration());
  }
  ...
  public void testOnlyErrorsAndWaiting() {
    validate(0, abfsThrottlingNetworkTrafficAnalysisResult.getWriteAnalysisResult().getSleepDuration());
    abfsThrottlingNetworkTrafficMetrics.getWriteMetrics().addBytesTransferred(8 * MEGABYTE, true);
    sleep(ANALYSIS_PERIOD_PLUS_10_PERCENT);
    final int expectedSleepDuration1 = 1100;
    validateLessThanOrEqual(expectedSleepDuration1, abfsThrottlingNetworkTrafficAnalysisResult.getWriteAnalysisResult().getSleepDuration());
    sleep(10 * ANALYSIS_PERIOD);
    final int expectedSleepDuration2 = 900;
    validateLessThanOrEqual(expectedSleepDuration2, abfsThrottlingNetworkTrafficAnalysisResult.getWriteAnalysisResult().getSleepDuration());
  }
  ...
  public void testSuccessAndErrorsAndWaiting() {
    validate(0, abfsThrottlingNetworkTrafficAnalysisResult.getWriteAnalysisResult().getSleepDuration());
    abfsThrottlingNetworkTrafficMetrics.getWriteMetrics().addBytesTransferred(2 * MEGABYTE, true);
    abfsThrottlingNetworkTrafficMetrics.getWriteMetrics().addBytesTransferred(8 * MEGABYTE, false);

    sleep(ANALYSIS_PERIOD_PLUS_10_PERCENT);
    NanoTimer timer = new NanoTimer();

    int sleepDuration = abfsThrottlingNetworkTrafficAnalysisResult.getWriteAnalysisResult().getSleepDuration();
    if (sleepDuration > 0) {
      sleep(sleepDuration);
    }
    ...
    validateLessThanOrEqual(expectedSleepDuration, abfsThrottlingNetworkTrafficAnalysisResult.getWriteAnalysisResult().getSleepDuration());
  }
