...
public class ITestAzureDistributedFileSystemFileStatus extends DependencyInjectedTest {
  public ITestAzureDistributedFileSystemFileStatus() throws Exception {
    super();
  }
