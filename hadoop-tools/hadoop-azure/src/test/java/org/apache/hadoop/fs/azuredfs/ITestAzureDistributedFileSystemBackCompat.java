...
public class ITestAzureDistributedFileSystemBackCompat extends DependencyInjectedTest {
  public ITestAzureDistributedFileSystemBackCompat() throws Exception {
    super();
  }
