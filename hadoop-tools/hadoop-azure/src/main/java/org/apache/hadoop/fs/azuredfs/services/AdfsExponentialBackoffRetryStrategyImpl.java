...
/**
 * Adfs Exponential Backoff Retry Strategy Implementation
 */
@InterfaceAudience.Private
@InterfaceStability.Evolving
public class AdfsExponentialBackoffRetryStrategyImpl implements AdfsRetryStrategy{
    ...
    /**
     * Initializes a new instance of the {@link AdfsExponentialBackoffRetryStrategyImpl} class.
     */
    public AdfsExponentialBackoffRetryStrategyImpl() {
     ...
     *                     between retries.
     */
    public AdfsExponentialBackoffRetryStrategyImpl(int retryCount, int minBackoff, int maxBackoff, int deltaBackoff) {
     ...
     *                     between retries.
     */
    public AdfsExponentialBackoffRetryStrategyImpl(String name, int retryCount, int minBackoff, int maxBackoff,
                                           int deltaBackoff) {
        this.name = name;
