...
public class SASStorageInterfaceImpl extends StorageInterface {

  public static final Logger LOG = LoggerFactory.getLogger(SASStorageInterfaceImpl.class);
  public static final String SAS_ERROR_CODE = "SAS Error";
  private SASKeyGeneratorInterface sasKeyGenerator;
  private String storageAccount;

  public SASStorageInterfaceImpl(boolean useLocalSASKeyMode, Configuration conf) {
  ...
  public void createBlobClient(CloudStorageAccount account) {
    ...
    LOG.error(errorMsg);
    throw new SASKeyModeNonSupportedException(errorMsg);
  }
  ...
  static class SASCloudBlobContainerWrapperImpl extends CloudBlobContainerWrapper {
