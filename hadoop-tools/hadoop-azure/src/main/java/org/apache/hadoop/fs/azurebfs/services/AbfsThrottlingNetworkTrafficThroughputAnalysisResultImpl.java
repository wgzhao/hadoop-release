...
final class AbfsThrottlingNetworkTrafficThroughputAnalysisResultImpl implements AbfsThrottlingNetworkThroughputAnalysisResult {
  private final AtomicInteger sleepDuration;
  private final AtomicLong consecutiveNoErrorCount;

  @Inject
  AbfsThrottlingNetworkTrafficThroughputAnalysisResultImpl() {
