...
package com.microsoft.azure.bfs.rest.client.generated;
...
/**
 * The interface for AzureBlobFileSystemRestClient class.
 */
@InterfaceStability.Evolving
public interface AzureBlobFileSystemRestClient {
  /**
   ...
   */
  AzureBlobFileSystemRestClient withXMsVersion(String xMsVersion);
   ...
   * @return the service client itself
   */
  AzureBlobFileSystemRestClient withAccountName(String accountName);
   ...
   * @return the service client itself
   */
  AzureBlobFileSystemRestClient withDnsSuffix(String dnsSuffix);
