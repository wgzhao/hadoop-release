...
/**
 * Defines headers for CreateFilesystem operation.
 */
...
public class CreateFilesystemHeaders {
   ...
   * @return the CreateFilesystemHeaders object itself.
   */
  public CreateFilesystemHeaders withETag(String eTag) {
    this.eTag = eTag;
    return this;
  }
   ...
   * @return the CreateFilesystemHeaders object itself.
   */
  public CreateFilesystemHeaders withLastModified(DateTime lastModified) {
   ...
   * @return the CreateFilesystemHeaders object itself.
   */
  public CreateFilesystemHeaders withXMsRequestId(String xMsRequestId) {
   ...
   * @return the CreateFilesystemHeaders object itself.
   */
  public CreateFilesystemHeaders withXMsVersion(String xMsVersion) {
   ...
   * @return the CreateFilesystemHeaders object itself.
   */
  public CreateFilesystemHeaders withXMsOriginationId(String xMsOriginationId) {
